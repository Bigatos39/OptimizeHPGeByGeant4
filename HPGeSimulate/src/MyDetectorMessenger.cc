...
MyDetectorMessenger::MyDetectorMessenger(MyDetectorConstruction *detector)
  ...
  calorimeterHelmetSizeCmd =
      new G4UIcmdWithAnInteger("/calorimeter/helmetSize", this);
...
MyDetectorMessenger::~MyDetectorMessenger() { delete calorimeterDir; }
