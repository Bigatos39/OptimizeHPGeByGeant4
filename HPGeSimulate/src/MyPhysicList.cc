...
void MyPhysicList::SetCuts() {
  if (verboseLevel > 0) {
    ...
    G4cout << "Cut Energy for Gamma: " << G4BestUnit(fCutForGamma, "Energy")
           << G4endl;
    G4cout << "Cut Energy for Electron: "
           << G4BestUnit(fCutForElectron, "Energy") << G4endl;
    G4cout << "Cut Energy for Positron: "
           << G4BestUnit(fCutForPositron, "Energy") << G4endl;
    // G4cout << "Cut Energy for Proton: " << G4BestUnit(fCutForProton,
    // "Energy") << G4endl;
  }
...
void MyPhysicList::SetGammaCut(G4double val) { fCutForGamma = val; }

void MyPhysicList::SetElectronCut(G4double val) { fCutForElectron = val; }

void MyPhysicList::SetPositronCut(G4double val) { fCutForPositron = val; }
